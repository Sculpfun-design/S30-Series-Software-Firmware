...
namespace WebUI {
    ...
    //defaults values
    static const char* DEFAULT_HOSTNAME = MACHINE_NAME; 
    ...
    static const char* DEFAULT_STA_IP            = "192.168.0.127"; 
    static const char* DEFAULT_STA_GW            = "192.168.0.1"; 
    static const char* DEFAULT_STA_MK            = "255.255.255.0"; 
    static const char* DEFAULT_AP_SSID           = MACHINE_NAME; 
    ...
    //so let set min is 8
    static const int MIN_PASSWORD_LENGTH             = 0; 
